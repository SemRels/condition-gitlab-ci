...
LABEL org.opencontainers.image.title="semrel-plugin-condition-gitlab-ci" \
      org.opencontainers.image.description="semrel plugin: condition-gitlab-ci" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/condition-gitlab-ci" \
